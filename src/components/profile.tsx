...
import { MdEmail, MdPhone, MdNoteAlt, MdRemoveRedEye, MdPerson } from 'react-icons/md';
        ...
        <div className="mt-[90px] overflow-y-auto">
            <div className="flex justify-between items-center border-b-[1px] pb-4 pl-8">
                <div className="flex justify-center">
                    ...
                    <div className="ml-5">
                        <h1 className="text-2xl font-bold">Mario Simmaco</h1>
                        <div className="flex">
                            <h4 className="text-primary-gray text-sm">Farmer</h4> <span className="dot text-primary-gray">&nbsp;&nbsp;•&nbsp;&nbsp;</span>
                            <h4 className="text-primary-gray text-sm">Ho Chi Minh City, Vietnam</h4>
                        </div>
                    </div>
                </div>
                <details className="dropdown dropdown-bottom dropdown-end bg-white ">
                    ...
                    <ul tabIndex={0} className="dropdown-content z-[8] menu p-2 shadow bg-base-100 rounded-box w-52">
            ...
            <div className="pl-8 pt-5 border-b-[1px] pb-4">
                <div className="flex justify-between">
                    ...
                    <button className="btn btn-primary btn-outline btn-sm mr-4 rounded-full normal-case custom-outline"><FaPlus />Tokenize tree</button>
                </div>
                <div className="">
                    <div className="flex mt-3">
                        <div className="bg-light-yellow rounded-lg w-[210px] py-4 px-8">
                            <LazyLoadImage src="/images/wallet-coin.svg" width={40} alt="/images/alt-img.svg" className="send-icon" />
                        ...
                        <div className="bg-light-green rounded-lg w-[210px] py-4 px-8 ml-2">
                            <LazyLoadImage src="/images/wallet-carbon.svg" width={50} alt="/images/alt-img.svg" className="send-icon" />
                    ...
                    <div className="flex mt-2">
                        <div className="bg-light-gray rounded-lg w-[210px] py-4 px-8">
                            <div className="flex justify-between items-center">
                                <LazyLoadImage src="/images/wallet-clock.svg" width={40} alt="/images/alt-img.svg" className="send-icon" />
                        ...
                        <div className="bg-light-gray rounded-lg w-[210px] py-4 px-8 ml-2">
                            <div className="flex justify-between items-center">
                                <LazyLoadImage src="/images/wallet-tree.svg" width={45} alt="/images/alt-img.svg" className="send-icon" />
                                <h1 className="text-3xl font-bold ml-auto">50</h1>
                            </div>
                            <div className="flex justify-end mt-4">
            ...
            <div className="personal-info border-b-[1px] pl-8 py-4">
                <div className="email">
                    ...
                    <h2 className="ml-12 text-sm"> edward@greenant.farm </h2>
                </div>
